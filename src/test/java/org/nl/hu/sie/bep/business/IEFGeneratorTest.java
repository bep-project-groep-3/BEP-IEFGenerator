...
public class IEFGeneratorTest {
  ...
  public Bedrijf createBedrijf() {
    ...
    factuur1Klant1.setDatumtijd(new Date());
    ...
    factuur2Klant2.setDatumtijd(new Date());
    ...
    factuur3Klant2.setDatumtijd(new Date());
  ...
  private BedrijfRow createCheckBedrijfRow() {
    ...
    factuurRow1Factuur1.setRegelDatum(new Date());
    ...
    factuurRow2Factuur1.setRegelDatum(new Date());
    ...
    factuurRow3Factuur1.setRegelDatum(new Date());
    ...
    factuur1Row.setFactuurdatum(new Date());
    ...
    factuurRow1Factuur2.setRegelDatum(new Date());
    ...
    factuur2Row.setFactuurdatum(new Date());
    ...
    factuurRow1Factuur3.setRegelDatum(new Date());
    ...
    factuurRow2Factuur3.setRegelDatum(new Date());
    ...
    factuur3Row.setFactuurdatum(new Date());
